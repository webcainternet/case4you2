...
if($o_user == 0)
{
    ...
    echo "<a class=\"button\" onclick=\"window.open('$url','_blank','toolbar=no, scrollbars=no, resizable=yes, top=400, left=500, width=850, height=170');\" href=\"#\">Entrar com Facebook</a>";
    ?> 
    <script>
