...
<div style="display: block; margin-left:10px; float: left; width: 350px; border-left-style: solid; border-left-width: 0px; border-left-color: rgb(204, 204, 204); height: 540px; text-align: center; background-position: 15px 10px; background-repeat: no-repeat no-repeat;">
...
<?php if ($_GET["m"] == "0") { ?>
<div style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 490px; width: 340px; background-size: 340px; background-image: url(https://case4you.com.br/app/img/mask-iphone4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "1") { ?>
<div style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 538px; width: 340px; background-size: 340px; background-image: url(https://case4you.com.br/app/img/mask-iphone5-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "2") { ?>
<div style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 527px; width: 340px; background-size: 340px; background-image: url(https://case4you.com.br/app/img/mask-galaxy3-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "3") { ?>
<div style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 499px; width: 340px; background-size: 340px; background-image: url(https://case4you.com.br/app/img/mask-galaxy4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>
