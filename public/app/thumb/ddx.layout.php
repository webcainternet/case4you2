...
<!-- LAYOUT 1 -->
        <div id="divmask" style="padding: 0px; height: <?php echo $mh-1; ?>px; width: 84px; background-size: 42px; background-image: url(http://case4you.com.br/case4you/0/img/<?php echo $mimage; ?>); background-repeat: no-repeat no-repeat;">
