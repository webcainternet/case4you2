...
<body class="<?php echo empty($this->request->get['route']) ? 'common-home' : str_replace('/', '-', $this->request->get['route']); ?>">
	<?php /* <center><h1>Em Manutenção</h1></center>  */ ?>
<div class="bg-1">
...
<div id="header">
	...
	<div class="topmenu">
		<div class="topmenu2">
			...
			<ul class="menu">
				<li>
					<a class="fancybox fancybox.iframe" href="https://case4you.com.br/app/?m=0">Crie Sua Capa</a>
					<!-- <ul style="position: absolute; z-index:1000;">
						<li><a class="fancybox fancybox.iframe" href="https://case4you.com.br/app/?m=0">Iphone 4</a></li>
						<li><a class="fancybox fancybox.iframe" href="https://case4you.com.br/app/?m=1">Iphone 5</a></li>
						<li><a class="fancybox fancybox.iframe" href="https://case4you.com.br/app/?m=2">Galaxy S3</a></li>
	...
	<div class="outer" style="margin-bottom: 20px; margin-top: 40px;">
	...
	<div style="float: left;margin-top: 55px;margin-left: 0px;width: 220px;">
		...
		<div class="fontc4y1" style="color: #606060; float: left; width: 220px;text-align: center;margin-bottom: 5px; ">
			...
			<input type="image" src="/catalog/view/theme/theme254/image/button-email.png" onclick="javascript: cademail()" style="width: 51px; float: left; margin-left: 5px; border-radius: 5px; margin-top: 5px;">
		</div>
