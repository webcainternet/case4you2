		...
		<div class="box-product box-subcat">
        	<ul><?php $i=0;?>
                ...
                <li class="cat-height <?php echo $a;?>">
                    ...
                    <?php } ?>
                    <div class="name subcatname" style="width: 1000px; float:left;" >
                        <a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
                        <br /><p>
                        Você encontra a <strong>Capinha</strong> ideal para o seu Celular na Case4You, em vários estilos: pode ser fitness, música, desenhos, nerd e mais. Você pode também criar a sua <a href="http://case4you.com.br/criar-capinha-personalizada">capinha personalizada</a>.
	 		</p>
