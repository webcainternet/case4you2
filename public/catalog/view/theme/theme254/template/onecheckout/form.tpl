  ...
  <div class="divclear">
	...
	<br />
	<br />
	<span class="required">*</span> <?php echo $entry_company; ?> <small>(Para a nota fiscal)</small><br />
  ...
  <div class="divclear"><small>Formato: DDD Telefone. Não insira o 0 no DDD ou pontuações.<br>Exemplo: 1199999999</small></div>
  <br />
