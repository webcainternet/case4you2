...
class ModelCheckoutOrder extends Model {
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'customers_id'             => $order_query->row['customer_id'],
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		$this->db->query("INSERT INTO debug SET log = '1STATUS CHECKOUT: ". $order_status_id ."'");
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			$this->db->query("INSERT INTO debug SET log = '2STATUS CHECKOUT: ". $order_status_id ."'");
			...
			$this->db->query("INSERT INTO debug SET log = '3STATUS CHECKOUT: ". $order_status_id ."'");

			if ($status) {
				$order_status_id = $this->config->get('config_order_status_id');
			}

			$this->db->query("INSERT INTO debug SET log = 'STATUS CHECKOUT: ". $order_status_id ."'");
            ...
            $template->data['firstname'] = $order_info['payment_firstname'];
			$template->data['base_url'] = $base_url;

			$template->data['total'] = number_format((float)$order_info['total'], 2);
			$template->data['shipping_method'] = $order_info['shipping_method'];
			...
			$shipping_cost = (float) $order_info['total'];
			...
			foreach ($order_product_query->rows as $product) {
				...
				$shipping_cost = $shipping_cost - (float) $product['total'];
			...
			$template->data['shipping_cost'] = number_format($shipping_cost, 2);
